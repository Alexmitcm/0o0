...
async function setupAdminSystem() {
    ...
    try {
        ...
        console.log("\n📋 Summary:");
        console.log(`- Created ${4} admin users (SuperAdmin, SupportAgent, Auditor, Moderator)`);
        console.log(`- Added ${supportPermissions.length + moderatorPermissions.length} permissions`);
