...
async function generateAdminJwt() {
    try {
        ...
        console.log("curl -X POST http://localhost:8080/admin/force-unlink-profile \\");
        console.log('  -H "Content-Type: application/json" \\');
        console.log(`  -H "Authorization: Bearer ${token}" \\`);
        console.log("  -d '{");
        console.log(`    "adminWalletAddress": "${adminWalletAddress}",`);
        console.log('    "targetWallet": "0x960FCeED1a0AC2Cc22e6e7Bd6876ca527d31D268",');
        console.log('    "reason": "Admin-triggered unlink for re-linking process."');
        console.log("  }'");
    }
    catch (error) {
