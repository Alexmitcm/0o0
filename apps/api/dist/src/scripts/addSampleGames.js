...
const sampleGames = [
    // Free to Play Games
    {
        ...
        description: "An exciting space exploration game where you pilot a spaceship through asteroid fields and discover new planets. Perfect for casual gaming!",
        gameType: "FreeToPlay",
        height: 720,
        iconUrl: "https://picsum.photos/512/512?random=space-icon",
        instructions: "Use arrow keys to move, spacebar to shoot, and collect power-ups to enhance your ship.",
    ...
    },
    {
        ...
        description: "Challenge your mind with hundreds of brain-teasing puzzles. From simple jigsaws to complex logic puzzles, there's something for everyone!",
        gameType: "FreeToPlay",
        height: 720,
        iconUrl: "https://picsum.photos/512/512?random=puzzle-icon",
        instructions: "Click and drag pieces to solve puzzles. Use hints if you get stuck!",
    ...
    },
    {
        ...
        description: "Get behind the wheel and race against the clock in this high-speed racing game. Master different tracks and unlock new cars!",
        gameType: "FreeToPlay",
        height: 720,
        iconUrl: "https://picsum.photos/512/512?random=racing-icon",
        instructions: "Use WASD or arrow keys to control your car. Avoid obstacles and collect boosters!",
    ...
    // Play to Earn Games
    {
        ...
        description: "Embark on an epic adventure in the blockchain world! Complete quests, defeat monsters, and earn cryptocurrency rewards. Premium subscription required.",
        gameType: "PlayToEarn",
        height: 720,
        iconUrl: "https://picsum.photos/512/512?random=crypto-icon",
        instructions: "Use WASD to move, mouse to attack. Complete quests to earn tokens and level up your character.",
    ...
    },
    {
        ...
        description: "Collect rare NFTs by playing this strategic card game. Trade, battle, and build your collection to earn real rewards!",
        gameType: "PlayToEarn",
        height: 720,
        iconUrl: "https://picsum.photos/512/512?random=nft-icon",
        instructions: "Drag cards to play them. Build powerful combinations and defeat opponents to earn NFT rewards.",
    ...
    },
    {
        ...
        description: "Manage your virtual farm and earn DeFi tokens! Plant crops, harvest rewards, and participate in yield farming. Premium features unlock real earnings!",
        gameType: "PlayToEarn",
        height: 720,
        iconUrl: "https://picsum.photos/512/512?random=farm-icon",
        instructions: "Click to plant seeds, water crops, and harvest rewards. Upgrade your farm to increase earnings.",
...
async function addSampleGames() {
    ...
    try {
        ...
        if (existingGames.length > 0) {
            ...
            console.log("Existing games:", existingGames.map((g) => g.title));
        }
        ...
        for (let i = 0; i < sampleGames.length; i++) {
            ...
            try {
                ...
                console.log(`   ❌ Error adding ${game.title}:`, error instanceof Error ? error.message : String(error));
            }
        }
        ...
        console.log("3. 🔒 Test P2E games access (should be locked for non-premium users)");
        console.log("4. 🎮 Test F2P games (should be accessible to all users)");
        console.log("5. 📊 Check admin panel for new games");
    }
    catch (error) {
        console.error("❌ Error adding sample games:", error instanceof Error ? error.message : String(error));
    }
    finally {
