...
async function testCoinSystem() {
    ...
    try {
        ...
        await CoinService_1.CoinService.initializeUserBalance(testWallet);
        let balance = await CoinService_1.CoinService.getUserBalance(testWallet);
        ...
        balance = await CoinService_1.CoinService.getUserBalance(testWallet);
        console.log("✅ Coins awarded successfully:", balance);
        // Test 3: Get coin history
        console.log("\n3. Testing coin history...");
        const history = await CoinService_1.CoinService.getUserCoinHistory(testWallet, 10, 0);
        console.log("✅ Coin history retrieved:", history.length, "entries");
        // Test 4: Get transactions
        console.log("\n4. Testing transactions...");
        const transactions = await CoinService_1.CoinService.getUserTransactions(testWallet, 10, 0);
        console.log("✅ Transactions retrieved:", transactions.length, "entries");
        // Test 5: Spend coins
        console.log("\n5. Testing coin spending...");
        await CoinService_1.CoinService.spendCoins(testWallet, "Experience", 25, "GamePlay", "game-123", { action: "purchase", gameId: "game-123" }, "Purchased game item");
        balance = await CoinService_1.CoinService.getUserBalance(testWallet);
        ...
        for (const user of testUsers) {
            await CoinService_1.CoinService.initializeUserBalance(user.wallet);
            await CoinService_1.CoinService.awardCoins({
                amount: user.coins,
                coinType: "Experience",
        ...
        const leaderboard = await LeaderboardService_1.LeaderboardService.getOrCreateLeaderboard("AllTime", "AllTime");
        ...
        const leaderboardWithRank = await LeaderboardService_1.LeaderboardService.getLeaderboardWithUserRank("AllTime", "AllTime", testWallet);
        ...
        await CoinService_1.CoinService.adjustCoins(testWallet, "Experience", 100, "Test adjustment", "0xadmin1234567890123456789012345678901234567890");
        balance = await CoinService_1.CoinService.getUserBalance(testWallet);
        console.log("✅ Admin adjustment successful:", balance);
        // Test 10: Test top users
        console.log("\n10. Testing top users...");
        const topUsers = await CoinService_1.CoinService.getTopUsersByCoins(10);
        ...
        const freeToEarnLeaderboard = await LeaderboardService_1.LeaderboardService.getOrCreateLeaderboard("FreeToEarn", "Weekly");
        const playToEarnLeaderboard = await LeaderboardService_1.LeaderboardService.getOrCreateLeaderboard("PlayToEarn", "Weekly");
        console.log("✅ Free to Earn leaderboard:", freeToEarnLeaderboard.entries.length, "entries");
        console.log("✅ Play to Earn leaderboard:", playToEarnLeaderboard.entries.length, "entries");
        // Test 13: Test deactivate old leaderboards
        console.log("\n13. Testing deactivate old leaderboards...");
        await LeaderboardService_1.LeaderboardService.deactivateOldLeaderboards();
        console.log("✅ Old leaderboards deactivated");
        // Test 14: Test user leaderboard history
        console.log("\n14. Testing user leaderboard history...");
        const userHistory = await LeaderboardService_1.LeaderboardService.getUserLeaderboardHistory(testWallet, 5);
        ...
        try {
            await client_1.default.coinTransaction.deleteMany({
                where: {
                    walletAddress: {
                        in: [
            ...
            await client_1.default.userCoin.deleteMany({
                where: {
                    walletAddress: {
                        in: [
                            "0x1234567890123456789012345678901234567890",
            ...
            await client_1.default.userCoinBalance.deleteMany({
                where: {
                    walletAddress: {
                        in: [
                            "0x1234567890123456789012345678901234567890",
...
exports.default = testCoinSystem;
