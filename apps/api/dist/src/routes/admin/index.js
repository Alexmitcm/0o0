 ...
 */
app.get("/user", rateLimiter_1.moderateRateLimit, (0, zod_validator_1.zValidator)("query", walletAddressSchema), AdminController_1.getAdminUserView);
/**
 * POST /admin/user
 * Get comprehensive admin view of a user (alternative to GET)
 */
app.post("/user", rateLimiter_1.moderateRateLimit, (0, zod_validator_1.zValidator)("json", walletAddressSchema), AdminController_1.getAdminUserViewPost);
/**
 * GET /admin/users
 * Get all users with admin view
 */
app.get("/users", rateLimiter_1.moderateRateLimit, (0, zod_validator_1.zValidator)("query", paginationSchema), AdminController_1.getAllAdminUsers);
/**
 * POST /admin/users
 * Get all users with admin view (alternative to GET)
 */
app.post("/users", rateLimiter_1.moderateRateLimit, AdminController_1.getAllAdminUsersPost);
/**
 * POST /admin/force-unlink-profile
 * Force unlink a profile (admin override)
 */
app.post("/force-unlink-profile", rateLimiter_1.moderateRateLimit, AdminController_1.forceUnlinkProfile);
/**
 * POST /admin/force-link-profile
 * Force link a profile (admin override)
 */
app.post("/force-link-profile", rateLimiter_1.moderateRateLimit, AdminController_1.forceLinkProfile);
/**
 * POST /admin/grant-premium
 * Grant premium access (admin override)
 */
app.post("/grant-premium", rateLimiter_1.moderateRateLimit, AdminController_1.grantPremiumAccess);
/**
 * POST /admin/add-note
 * Add admin note to user
 */
app.post("/add-note", rateLimiter_1.moderateRateLimit, AdminController_1.addAdminNote);
/**
 * GET /admin/stats
 * Get enhanced admin statistics
 */
app.get("/stats", rateLimiter_1.moderateRateLimit, AdminController_1.getAdminStats);
/**
 * GET /admin/actions
 * Get admin action history
 */
app.get("/actions", rateLimiter_1.moderateRateLimit, (0, zod_validator_1.zValidator)("query", paginationSchema), AdminController_1.getAdminActionHistory);
/**
 * POST /admin/actions
 * Get admin action history (alternative to GET)
 */
app.post("/actions", rateLimiter_1.moderateRateLimit, AdminController_1.getAdminActionHistoryPost);
/**
 * GET /admin/features
 * Get feature list
 */
app.get("/features", rateLimiter_1.moderateRateLimit, AdminController_1.getFeatureList);
/**
 * POST /admin/features/access
 * Update feature access for a user
 */
app.post("/features/access", rateLimiter_1.moderateRateLimit, AdminController_1.updateFeatureAccess);
/**
 * GET /admin/admin-user
 * Get admin user information
 */
app.get("/admin-user", rateLimiter_1.moderateRateLimit, (0, zod_validator_1.zValidator)("query", walletAddressSchema), AdminController_1.getAdminUserInfo);
/**
 * POST /admin/admin-user
 * Get admin user information (alternative to GET)
 */
app.post("/admin-user", rateLimiter_1.moderateRateLimit, (0, zod_validator_1.zValidator)("json", walletAddressSchema), AdminController_1.getAdminUserInfoPost);
/**
 * GET /admin/coin-transactions
 * Get coin transaction history
 */
app.get("/coin-transactions", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        ...
        return c.json({ error: "Failed to fetch coin transactions", success: false }, 500);
    }
});
/**
 ...
 * Get coin statistics
 */
app.get("/coin-stats", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
 ...
 */
app.get("/system-status", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        ...
        return c.json({ error: "Failed to fetch system status", success: false }, 500);
    }
});
/**
 ...
 */
app.get("/system-actions", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        const actions = [
            {
        ...
        return c.json({ error: "Failed to fetch system actions", success: false }, 500);
    }
});
/**
 ...
 */
app.get("/tournaments", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        ...
        return c.json({ error: "Failed to fetch tournaments", success: false }, 500);
    }
});
/**
 ...
 */
app.post("/system/backup", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
 ...
 */
app.post("/system/reset-daily-points", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        ...
        return c.json({ error: "Failed to reset daily points", success: false }, 500);
    }
});
/**
 ...
 */
app.post("/system/clear-cache", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
 ...
 */
app.get("/games", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        const { limit = "20", page = "1" } = c.req.query();
        const limitNum = Number.parseInt(limit);
        const pageNum = Number.parseInt(page);
        ...
        const games = Array.from({ length: limitNum }, (_, i) => ({
            category: ["Action", "Puzzle", "Strategy", "Arcade"][Math.floor(Math.random() * 4)],
            id: `game_${skip + i + 1}`,
 ...
 * Get game statistics
 */
app.get("/game-stats", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        const stats = {
            activeGames: 20,
            averageRating: 4.2,
 ...
 */
app.get("/contracts", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        const { limit = "20", page = "1" } = c.req.query();
        const limitNum = Number.parseInt(limit);
        const pageNum = Number.parseInt(page);
 ...
 */
app.get("/contract-stats", rateLimiter_1.moderateRateLimit, async (c) => {
    try {
        const stats = {
            activeContracts: 10,
            contractTypes: [
        ...
        return c.json({ error: "Failed to fetch contract stats", success: false }, 500);
    }
});
/**
 * GET /admin/health
