...
const apiDocs = async (c) => {
    const docs = {
        ...
        info: {
            ...
            description: "Social media platform API with gaming, tournaments, and premium features",
            title: "Hey API",
            version: "1.0.0"
        },
        openapi: "3.0.0",
        paths: {
            ...
            "/health": {
                get: {
                    description: "Comprehensive health check including database, Redis, and system metrics",
                    responses: {
                        "200": {
                            content: {
                                "application/json": {
